                ...
                <div className=" mt-7">
                    <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                        ...
                        <div className="">
                            ...
                            <textarea name="" id="messageInput" className="border border-gray-200 w-full h-20 resize-none bg-surface p-1" placeholder="Enter Message" value={message} onChange={(e) => setMessage(e.target.value)} ></textarea>
                        </div>
